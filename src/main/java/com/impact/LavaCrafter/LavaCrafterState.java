...
public enum LavaCrafterState {
    ...
    DEPOSIT_LAVAS(10, "Deposit-All", "<col=ff9040>Lava rune</col>", 8, 57, 1, 983043, LavaCrafterStateType.BANK_INVENTORY_ITEM),
    ...
    TELE_PVP_ARENA(20, "PvP Arena", "<col=ff9040>Ring of dueling(4)</col>", 2, 57, -1, 25362456),
    ...
    WEAR_DUELING_RING(10, "Wear", "<col=ff9040>Ring of dueling(8)</col>", 9, 1007, 2, 983043, LavaCrafterStateType.BANK_INVENTORY_ITEM),
    WITHDRAW_BINDING_NECKLACE(10, "Withdraw-1", "<col=ff9040>Binding necklace</col>", 1, 57, 15, 786444, LavaCrafterStateType.BANK_ITEM),
    WEAR_BINDING_NECKLACE(10, "Wear", "<col=ff9040>Binding necklace</col>", 9, 1007, 2, 983043, LavaCrafterStateType.BANK_INVENTORY_ITEM);
